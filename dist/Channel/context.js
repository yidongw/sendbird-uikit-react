...
import { m as mergeAndSortMessages, p as passUnsuccessfullMessages, s as scrollIntoLast, d as scrollToRenderedMessage, g as getAllEmojisMapFromEmojiContainer, e as getNicknamesMapFromMembers } from '../chunks/bundle-D-F3KakE.js';
...
import { K, l as isSendableMessage, a2 as S, a4 as filterMessageListParams } from '../chunks/bundle-Bd-i99nk.js';
import { R as RESET_MESSAGES, F as FETCH_INITIAL_MESSAGES_START, a as FETCH_INITIAL_MESSAGES_SUCCESS, c as FETCH_PREV_MESSAGES_SUCCESS, d as FETCH_NEXT_MESSAGES_SUCCESS, b as FETCH_INITIAL_MESSAGES_FAILURE, e as FETCH_PREV_MESSAGES_FAILURE, f as FETCH_NEXT_MESSAGES_FAILURE, S as SEND_MESSAGE_START, g as SEND_MESSAGE_SUCCESS, h as SEND_MESSAGE_FAILURE, i as SET_CURRENT_CHANNEL, j as SET_CHANNEL_INVALID, O as ON_MESSAGE_RECEIVED, k as ON_MESSAGE_UPDATED, l as ON_MESSAGE_THREAD_INFO_UPDATED, m as RESEND_MESSAGE_START, n as MARK_AS_READ, o as ON_MESSAGE_DELETED, p as ON_MESSAGE_DELETED_BY_REQ_ID, q as SET_EMOJI_CONTAINER, r as ON_REACTION_UPDATED, M as MESSAGE_LIST_PARAMS_CHANGED, s as ON_FILE_INFO_UPLOADED, t as ON_TYPING_STATUS_UPDATED, u as channelActions } from '../chunks/bundle-DDTq-6FS.js';
import { c as compareIds } from '../chunks/bundle-zVlBKrSk.js';
import { P as PREV_RESULT_SIZE, N as NEXT_RESULT_SIZE, u as useInitialMessagesFetch } from '../chunks/bundle-DMEhFKKv.js';
import { u as useLocalization } from '../chunks/bundle-DhMUg-L7.js';
import { GroupChannelHandler } from '@sendbird/chat/groupChannel';
import { u as uuidv4 } from '../chunks/bundle-C5iY_IvV.js';
import { u as useReconnectOnIdle } from '../chunks/bundle-JQDTfT_2.js';
import { c as SCROLL_BOTTOM_DELAY_FOR_FETCH, d as SCROLL_BOTTOM_DELAY_FOR_SEND, e as VOICE_MESSAGE_FILE_NAME, a as VOICE_MESSAGE_MIME_TYPE, M as META_ARRAY_VOICE_DURATION_KEY, f as META_ARRAY_MESSAGE_TYPE_KEY, g as META_ARRAY_MESSAGE_TYPE_VALUE__VOICE } from '../chunks/bundle-DQk0aENq.js';
import { p as pubSubTopics, b as PublishingModuleType, P as PUBSUB_TOPICS, s as shouldPubSubPublishToChannel } from '../chunks/bundle-BwmZGijR.js';
import { u as useToggleReactionCallback } from '../chunks/bundle-CZtAsa-i.js';
import { g as getCaseResolvedReplyType, a as getCaseResolvedThreadReplySelectType } from '../chunks/bundle-CUhgRMBc.js';
import { u as useSendMultipleFilesMessage } from '../chunks/bundle-B43UOaqG.js';
