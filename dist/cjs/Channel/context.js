...
var actionTypes = require('../chunks/bundle-wYxshM30.js');
var compareIds = require('../chunks/bundle-Dh0NAI0D.js');
...
var useReconnectOnIdle = require('../chunks/bundle-DrScP7Am.js');
var consts = require('../chunks/bundle-BD0wJiNh.js');
var pubSub_topics = require('../chunks/bundle-C6Q6BfQY.js');
var useToggleReactionCallback = require('../chunks/bundle-CpJ9tVDn.js');
...
function channelReducer(state, action) {
    ...
    return index.K(action)
        ...
        return _tslib.__assign(_tslib.__assign({}, state), { currentGroupChannel: channel, unreadSince: (_a = state.unreadSince) !== null && _a !== void 0 ? _a : index$1.format(new Date(), stringSet.DATE_FORMAT__UNREAD_SINCE), unreadSinceDate: (_b = state.unreadSinceDate) !== null && _b !== void 0 ? _b : new Date(), allMessages: utils.passUnsuccessfullMessages(state.allMessages, message) });
    })
