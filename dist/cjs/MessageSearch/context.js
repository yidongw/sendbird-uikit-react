...
var MessageSearchContext = React__default.default.createContext(null);
var MessageSearchProvider = function (props) {
    ...
    return (React__default.default.createElement(MessageSearchContext.Provider, { value: {
...
var useMessageSearchContext = function () {
    var context = React__default.default.useContext(MessageSearchContext);
    if (!context)
