...
var VoiceRecorderProvider = function (props) {
    ...
    React.useEffect(function () {
        if (isVoiceMessageEnabled && !webAudioUtils) {
            Promise.resolve().then(function () { return require('./bundle-8sTM0CXH.js'); }).then(function (module) { return setWebAudioUtils(module); });
        }
...
//# sourceMappingURL=bundle-DfISCDoH.js.map
